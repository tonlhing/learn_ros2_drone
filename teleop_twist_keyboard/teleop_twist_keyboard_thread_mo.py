...
if __name__=="__main__":
    ...
    pub2 = rospy.Publisher('drone/takeoff', std_msgs.msg.Empty, queue_size=10)

    # Create a Publisher for the drone/land topic
    pub3 = rospy.Publisher('drone/land', std_msgs.msg.Empty, queue_size=10)
    ...
    try:
        ...
        while(1):
            ...
            if key in moveBindings.keys():
                ...
                # Publish an empty message to the drone/takeoff topic
                pub2.publish(std_msgs.msg.Empty())
                print("Takeoff command sent.")
            elif key == '2':
                # Publish an empty message to the drone/takeoff topic
                pub3.publish(std_msgs.msg.Empty())
